...
import CompetitiveLandscape from '../components/CompetitiveLandscape.jsx';
  ...
  return (
    <div className="flex h-full">
      <div className="flex-1 overflow-auto p-6">
        ...
        {result ? (
          <>
            {/* Competitive Landscape — only when 2+ products */}
            {hasMultipleProducts && (
              <CompetitiveLandscape result={result} products={analysis.products} />
            )}
